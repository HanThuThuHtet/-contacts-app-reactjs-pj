...
const Create = () => {
  ...
  return (
      ...
      <form onSubmit={onSubmitHandler} className='w-96 flex-col  p-5 rounded shadow mx-auto mt-4'>
        <h1 className='text-gray-800 text-2xl font-bold mb-5'>Create New Contact</h1>
        ...
        <div>
          <button type='submit' className='text-white bg-gray-800  px-4 py-2 rounded shadow-md my-5 uppercase text-sm'>Create</button>
          <Link to="/">
